...
public class MeasurementsController {
	...
	public String listNextPage(@PathVariable("page") int page,
		...
		Page<Measurement> measurementsPage = measurementsService.findAllByPage(pageRequest);
		List<Measurement> measurements = Lists.newArrayList(measurementsPage.iterator());
	...
	public List<MeasurementsView> getMeasurementsView(
		...
		if (listOfMeasurementsViews.getMeasurementsViews().isEmpty()) {
			...
			if ((measurements.size() < rowAtPage) && (numberOfLastPage > 0)) {
				...
				List<Measurement> newMeasurements = Lists.newArrayList(measurementsPage
						.iterator());
				Collections.reverse(measurements);
	...
	public List<ModelOfEquipment> getAllModels() {
	...
	public List<TypeOfSpectrum> getAllTypes() {
		return typesOfSpectrumService.findAll();
	}

	@ModelAttribute("screenResolutions")
	public List<ScreenResolution> getAllScreenResolutions() {
